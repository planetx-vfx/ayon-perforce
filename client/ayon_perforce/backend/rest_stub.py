...
class PerforceRestStub:
    ...
    @staticmethod
    def _wrap_call(command: str, **kwargs: Union[str, int, pathlib.Path]) -> dict:
    ...
    def is_in_any_workspace(path: Union[str, pathlib.Path]) -> dict:
        ...
        """
        return PerforceRestStub._wrap_call("is_in_any_workspace", path=path)

    @staticmethod
    def login(
        host: str, port: int, username: str, password: str, workspace_name: str
    ) -> dict:
    ...
    def add(path: Union[str, pathlib.Path], comment: str = "") -> dict:
        ...
        """
        return PerforceRestStub._wrap_call("add", path=path, comment=comment)
    ...
    def sync_latest_version(path: Union[str, pathlib.Path]) -> dict:
        ...
        """
        return PerforceRestStub._wrap_call("sync_latest_version", path=path)
    ...
    def checkout(path: Union[str, pathlib.Path], comment: str = "") -> dict:
        ...
        """
        return PerforceRestStub._wrap_call("checkout", path=path, comment=comment)
    ...
    def is_checkouted(path: Union[str, pathlib.Path]) -> dict:
        ...
        """
        return PerforceRestStub._wrap_call("is_checkouted", path=path)
    ...
    def submit_change_list(comment: str) -> dict:
        ...
        """
        return PerforceRestStub._wrap_call("submit_change_list", comment=comment)
    ...
    def exists_on_server(path: Union[str, pathlib.Path]) -> dict:
        ...
        """
        return PerforceRestStub._wrap_call("exists_on_server", path=path)
    ...
    def revert(path):
        ...
        Args:
            path (str): Path to the file.
        """
        response = PerforceRestStub._wrap_call("revert", path=path)
        return response
    ...
    def get_stream(workspace_name: str) -> dict:
        ...
        """
        return PerforceRestStub._wrap_call("get_stream", workspace_name=workspace_name)
